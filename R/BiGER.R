...
#' 
#' This is the BiGER algorithm implemented using Mean-Field Variational Inference.
#' For the reference BiGER algorithm based on MCMC, see \link[gBiGER]{gBiGER()} or
#' \link[BiGER]{bBiGER()}.
#'
